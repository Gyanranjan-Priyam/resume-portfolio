...
const projects = [
  ...
  },
  {
    ...
    images: [
      {
        src: 'https://res.cloudinary.com/df2x3ampe/image/upload/v1774454594/1_aqmepk.png',
        tag: 'big',
        isRight: false,
      },
      {
        src: 'https://res.cloudinary.com/df2x3ampe/image/upload/v1774454595/2_ddvhs5.png',
        tag: 'big',
        isRight: false,
      },
      {
        src: 'https://res.cloudinary.com/df2x3ampe/image/upload/v1774454594/3_hiqyta.png',
        tag: 'big',
        isRight: false,
      },
      {
        src: 'https://res.cloudinary.com/df2x3ampe/image/upload/v1774454594/5_ymxmvt.png',
        tag: 'big',
        isRight: false,
      },
      {
        src: 'https://res.cloudinary.com/df2x3ampe/image/upload/v1774454595/4_dnmcz0.png',
        tag: 'big',
        isRight: false,
      },
    ],
    ...
    techDetailed: [
      { layer: 'Framework', value: 'Next.js 16 (App Router, RSC)' },
      { layer: 'Language', value: 'TypeScript' },
      { layer: 'Styling', value: 'Tailwind CSS v4 + Radix UI' },
      { layer: 'Database', value: 'Prisma ORM' },
      { layer: 'Authentication', value: 'Better Auth' },
      { layer: 'Rich Text Editor', value: 'TipTap v3' },
      { layer: 'Real-time', value: 'Socket.io' },
      { layer: 'File Storage', value: 'AWS S3' },
      { layer: 'Forms', value: 'React Hook Form + Zod' },
      { layer: 'Animations', value: 'Framer Motion + GSAP' },
      { layer: 'Charts', value: 'Recharts' },
      { layer: 'Security', value: 'Arcjet (rate limiting & bot protection)' },
      { layer: 'Email', value: 'Nodemailer' },
      { layer: 'Deployment', value: 'Vercel' },
    ],
    folderStructure: [
      { name: 'app', type: 'folder', children: [
        { name: '(auth)', type: 'folder', children: [
          { name: 'login', type: 'folder', children: [
            { name: '_components', type: 'folder', children: [{ name: 'LoginForm.tsx', type: 'file' }] },
            { name: 'page.tsx', type: 'file' },
          ]},
          { name: 'layout.tsx', type: 'file' },
        ]},
        { name: '(homepage)', type: 'folder', children: [
          { name: '_components', type: 'folder', children: [
            { name: 'Header.tsx', type: 'file' },
            { name: 'MobileSearch.tsx', type: 'file' },
            { name: 'types.ts', type: 'file' },
          ]},
          { name: '[username]', type: 'folder', children: [{ name: 'page.tsx', type: 'file' }] },
          { name: 'create', type: 'folder', children: [
            { name: '_components', type: 'folder', children: [
              { name: 'rich-text-editor.tsx', type: 'file' },
              { name: 'floating-menubar.tsx', type: 'file' },
              { name: 'code-editor.tsx', type: 'file' },
              { name: 'thumbnail-uploader.tsx', type: 'file' },
              { name: 'table-editor.tsx', type: 'file' },
              { name: 'video-player.tsx', type: 'file' },
            ]},
            { name: 'preview', type: 'folder', children: [{ name: 'page.tsx', type: 'file' }] },
            { name: 'page.tsx', type: 'file' },
          ]},
          { name: 'edit', type: 'folder', children: [
            { name: '[slug]', type: 'folder', children: [
              { name: 'EditBlogClient.tsx', type: 'file' },
              { name: 'page.tsx', type: 'file' },
            ]},
          ]},
        ...
        { name: 'api', type: 'folder', children: [
          { name: 'auth', type: 'folder', children: [{ name: '[...all]', type: 'folder', children: [{ name: 'route.ts', type: 'file' }] }] },
          { name: 'blogs', type: 'folder', children: [{ name: 'route.ts', type: 'file' }] },
          { name: 'follow', type: 'folder', children: [{ name: 'route.ts', type: 'file' }] },
          { name: 's3', type: 'folder', children: [{ name: 'upload', type: 'folder', children: [{ name: 'route.ts', type: 'file' }] }] },
          { name: 'socket', type: 'folder', children: [{ name: 'io', type: 'folder', children: [{ name: 'route.ts', type: 'file' }] }] },
          { name: 'tweets', type: 'folder', children: [{ name: 'route.ts', type: 'file' }] },
          { name: 'user', type: 'folder', children: [{ name: 'route.ts', type: 'file' }] },
        ]},
        { name: 'blogs', type: 'folder', children: [
          { name: '[slug]', type: 'folder', children: [
            { name: 'BlogDetailClient.tsx', type: 'file' },
            { name: 'page.tsx', type: 'file' },
          ]},
        ]},
        { name: 'profile', type: 'folder', children: [
          { name: '[username]', type: 'folder', children: [{ name: 'page.tsx', type: 'file' }] },
        ]},
