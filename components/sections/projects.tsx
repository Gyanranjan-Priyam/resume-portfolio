    ...
    <>
      ...
      <div className="fixed inset-0 grid place-items-center z-100 pointer-events-none">
        <motion.div
          ...
          ref={ref}
          className="pointer-events-auto relative w-full max-w-125 h-full md:h-fit md:max-h-[90%] flex flex-col bg-white dark:bg-neutral-900 sm:rounded-3xl overflow-hidden"
        >
          <motion.button
